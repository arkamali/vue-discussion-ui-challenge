...
<template>
  <div class="like" :class="[{ 'is-liked': iLikedIt }]" @click="like()">
    <svg
      :fill="iLikedIt ? '#fff' : '#909bb3'"
      height="20px"
      width="20px"
      version="1.1"
    ...
    >
      <g>
        <path
          d="M25.334,17.932c0,1.291-1.193,2.104-2.486,2.104h-0.01c0.965,0.166,2.111,1.331,2.111,2.462
